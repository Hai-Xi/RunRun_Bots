...
import com.test.runrunbots.model.dto.user.UserDTO;
...
public class UserController {
    ...
    public ResponseEntity<UserDTO> register(@RequestBody UserRegistrationRequest request) {
        ...
        authenticationService.register(request.getUsername(), request.getEmail(), request.getPhone(), request.getPassword());
